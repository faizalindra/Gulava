                        ...
                        <tbody>
                                ...
                                <td class="w-30">
                                    <div class="d-flex px-2 py-1 align-items-center">
                                        ...
                                        <div class="ms-4">
                                            ...
                                            <h6 class="text-sm mb-0">Mahmud</h6>
                                        </div>
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td class="w-30">
                                    <div class="d-flex px-2 py-1 align-items-center">
                                        <div>
                                            <img src="/img/team-2.jpg" class="avatar avatar-sm me-3" alt="user2">
                                        </div>
                                        <div class="ms-4">
                                            <!-- <p class="text-xs font-weight-bold mb-0">Country:</p> -->
                                            <h6 class="text-sm mb-0">Muhammad Salman</h6>
                                        </div>
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td class="w-30">
                                    <div class="d-flex px-2 py-1 align-items-center">
                                        <div>
                                            <img src="/img/team-4.jpg" class="avatar avatar-sm me-3" alt="user2">
                                        </div>
                                        <div class="ms-4">
                                            <!-- <p class="text-xs font-weight-bold mb-0">Country:</p> -->
                                            <h6 class="text-sm mb-0">Unyil</h6>
                                        </div>
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td class="w-30">
                                    <div class="d-flex px-2 py-1 align-items-center">
                                        ...
                                        <div class="ms-4">
                                            <!-- <p class="text-xs font-weight-bold mb-0">Country:</p> -->
                                            <h6 class="text-sm mb-0">Santia Riski</h6>
                                        </div>
                                    </div>
                                </td>
                                <td>
                    ...
                    <ul class="list-group">
                        <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-flex flex-column">
                                    <h6 class="mb-1 text-dark text-sm">Grade A</h6>
                        ...
                        <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-flex flex-column">
                                    <h6 class="mb-1 text-dark text-sm">Grade B</h6>
                                    <span class="text-xs">250 in stock</span>
                                </div>
                            </div>
                            <div class="d-flex">
                        ...
                        <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-flex flex-column">
                                    <h6 class="mb-1 text-dark text-sm">Semi</h6>
                                    <span class="text-xs">250 in stock</span>
                                </div>
                            </div>
                            <div class="d-flex">
                        ...
                        <li class="list-group-item border-0 d-flex justify-content-between ps-0 border-radius-lg">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-flex flex-column">
                                    <h6 class="mb-1 text-dark text-sm">Asli</h6>
                                    <span class="text-xs">250 in stock</span>
                                </div>
                            </div>
                            <div class="d-flex">
